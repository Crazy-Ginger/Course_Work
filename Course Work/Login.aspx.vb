...
Public Class Login
    ...
    Protected Sub B_Login_Click(sender As Object, e As EventArgs) Handles B_Login.Click
        ...
        Dim reader_pass As OleDbDataReader = passwords.ExecuteReader()
        Dim reader_user As OleDbDataReader = usernames.ExecuteReader()
        Dim login_tx As String = Tb_username.Text
        Dim password_tx As String = Tb_password.Text
        If login_tx <> (reader_user).ToString And password_tx <> (reader_pass).ToString Then
            L_Incorrect.Visible = True
        ElseIf login_tx = (reader_user).ToString And password_tx = (reader_pass).ToString Then
