...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent" EnableEventValidation="true">
    <div class="jumbotron">
        ...
        <div class="d_Boxes">
        <div id="Left" class="Left"><asp:TextBox ID="tb_Start" runat="server" Width="200px" Placeholder="Start Location" AutoCompleteType="HomeZipCode"></asp:TextBox>
        <asp:Label ID="lb_noStart" runat="server" width="200px" ForeColor="Red" Text="The route needs a Start" Visible="False"></asp:Label></div>
        <div id="ToRight" class="ToRight"><asp:TextBox ID="tb_End" runat="server" Width="300px" Placeholder="Final Destination (optional)" AutoCompleteType="HomeZipCode"></asp:TextBox></div>
        <br />
